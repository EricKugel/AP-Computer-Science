/**
 * An account is comprised of the rate, owner's name, account number, and balance,
...
public class Account {
  ...
  public double withdraw(double amount) {
    if (amount < 0 || balance - 1.5 < amount) {
      System.out.println("Error - amount to withdraw is less than 0 or greater than your balance plus a service fee.");
    } else {
      balance -= amount + 1.5;
    }
    return balance;
