/**
 * Member info is comprised of a club member's name, graduation year, and standing.
 */
public class MemberInfo {
  ...
  /** 
   * Constructs a MemberInfo object for the club member with name, graduation year, and standing.
   ...
   * @param hasGoodStanding  true if the club member has fulfilled the responsibilities of club membership;
   *                         false otherwise
   */
   ...
   * Not implemented in the original AP question.
   * 
   * @return  true if the club member has fulfilled the responsibilities of club membership;
   *          false otherwise
   */
  ...
  /**
   * Changes standing for the club member.  If previously false, standing is changed to true.
   * If previously true, standing is changed to false.
   * Not included in the original AP question.
   */
