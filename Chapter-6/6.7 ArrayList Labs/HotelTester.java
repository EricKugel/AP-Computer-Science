...
public class HotelTester {
  public static void main(String[] args) {
    ...
    disney.requestRoom("Pluto");         // Puts Pluto in room 1
    disney.requestRoom("Mickey");        // Puts Mickey in room 3
    disney.requestRoom("Donald");        // Puts Donald 1st on wait list
    disney.requestRoom("Pete");          // Puts Pete 2nd on wait list
    System.out.println(disney + "\n");
    
    disney.cancelAndReassign(request03); // Removes Daisy and puts Donald in room 2
    System.out.println(disney + "\n");
    
    Reservation request09 = disney.cancelAndReassign(request01); // Removes Minnie and puts Pete in room 0
    System.out.println(disney + "\n");
    
    disney.cancelAndReassign(request09); // Removes Pete
    System.out.println(disney + "\n"); 
