...
/**
 * A hotel contains the rooms and the waiting list for those rooms.  Rooms can be requested and cancelled.
 */
public class Hotel {
  ...
  /**
   * Constructs a Hotel object by instantiating rooms array and waitList ArrayList.
   ...
   * reservation for an empty room for the specified guest and returns the new Reservation;
   * otherwise, adds the guest to the end of waitList and returns null.
   * 
  ...
  /** Releases the room associated with parameter res, effectively canceling the reservation;
    * if any names are stored in waitList, removes the first name and creates a Reservation
    * for this person in the room reserved by res; returns that new Reservation;
    * if waitList is empty, marks the room specified by res as empty and returns null.
