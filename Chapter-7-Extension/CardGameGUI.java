...
public class CardGameGUI extends JFrame implements ActionListener {
  ...
  public CardGameGUI(Board gameBoard) {
    ...
    // initializes cardCoords using 5 cards per row
  ...
  /** 
   * Draws the display (cards and messages).
   */
  public void repaint() {
  ...
  private void initDisplay() {
    ...
    // of ...Board or ...board, uses the prefix for the JFrame title
    ...
    // Calculates number of rows of cards (5 cards per row)
    // and adjusts JFrame height if necessary
  ...
  /** 
   * Deals with the user clicking on something other than a button or a card.
   */
  ...
  /** Responds to a button click (on either the "Replace" button
